...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="" id="manage-designer">
				<div class="card">
					<div class="card-header">
						   Designer's Registration Form
				  	</div>
					<div class="card-body">
							<div id="msg"></div>
							...
							<div class="form-group">
								<label class="control-label">Design Specialties</label>
								<select name="specialty_ids[]" id="" multiple=""  class="custom-select browser-default select2">
									<option value=""></option>
									<?php 
									$qry = $conn->query("SELECT * FROM design_specialty order by name asc");
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM designers_list order by id asc");
